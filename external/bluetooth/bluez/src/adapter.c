...
{
	//20121017 P12116_BT_SYSTEM disable MMS feature for MAP profile ++++
	//return add_mas_record(adapter, 16, 0, 0x0E, "SMS/MMS Message Access");
	return add_mas_record(adapter, 16, 0, 0x06, "SMS Message Access");
	//20121017 P12116_BT_SYSTEM disable MMS feature for MAP profile ----
}
...
#endif
#ifdef ANDROID
// +++ [p14987] BT_SYS SDP_ATTRIBUTE_FEATURE
/*
The default setting '0x07' means it supports below features.
0 Three-way calling (0x01)
1 EC and/or NR function (0x02)
2 Voice recognition function (0x04)
*/
#if defined(EF52S_SDP_ATTR_FEATURE) || defined(EF52W_SDP_ATTR_FEATURE) || defined(EF52K_SDP_ATTR_FEATURE)
	u16 = 0x03; // remove Voice recognition
#elif defined(EF52L_SDP_ATTR_FEATURE)
	u16 = 0x02; // remove Three-way calling, Voice recognition 
#else
	u16 = 0x07; // Etc
#endif
// --- [p14987] BT_SYS SDP_ATTRIBUTE_FEATURE
	...
	for (i = 0; i < len; i++) {
		switch (svc_classes[i]) {
			...
			case OBEX_MAS_SVCLASS_ID:
				...
				//20121017 P12116_BT_SYSTEM disable EMAIL feature for MAP ++++
				//mas1_handle = add_mas1_record(adapter);
				//20120130 P12116_BT_SYSTEM disable EMAIL feature for MAP ----
				break;
		}
		if (ret < 0) {
			g_free(handles);
...
static void get_le_key_info(void *klist, char *hash, char *value)
{
