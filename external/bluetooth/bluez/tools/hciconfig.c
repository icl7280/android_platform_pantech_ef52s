...
//20121017 P12116_BT_SYSTEM hciconfig linkkey_byte_order ++++
static void cmd_getkey(int ctl, int hdev, char *opt)
{
...
static struct {
	...
	//20111115 lhw_device hciconfig linkkey_byte_order ++++
	{ "getkey", cmd_getkey, "<bdaddr>", "Load link key on the device" },
	//20111115 lhw_device hciconfig linkkey_byte_order ----
